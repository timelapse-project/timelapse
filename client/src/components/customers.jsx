...
class Customers extends Component {
  ...
  handleSearchCustomerActivitiesLog = async () => {
    ...
    let customerActivities = await timelapseInstance.methods
      .getCustomerActivitiesLog(
        phoneHash,
    ...
    for (let i = 0; i < customerActivities.length; i++) {
      customerActivities[i].time = new Intl.DateTimeFormat("en-US", {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
        hour: "2-digit",
        minute: "2-digit",
        second: "2-digit",
      }).format(new Date(customerActivities[i].timestamp * 1000));
    }
    this.setState({
          ...
          <div className="col-sm-12">
            <div className="card text-center bg-info text-white">
              ...
              <div className="card-body">
                <div className="row">
                  <p>
                    Search the activities log for a customer in a given period.
                  </p>
                </div>
              </div>
            </div>
  ...
  renderCustomerCareSearch() {
    ...
    const { startDate, endDate, phoneHashError } = this.state;
    return (
      <React.Fragment>
        <br></br>
        <div className="row">
              ...
              <div className="card-body">
                <div className="form-group row">
                  ...
                  <div className="col-sm-5">
                    ...
                    ></input>
                    <div className="invalid-feedback">{phoneHashError}</div>
                  </div>
                </div>
                <br></br>
                <div className="form-group row">
